...
const Products = () => <div className="p-8 text-gray-500">Page Produits — Ndoumbe</div>;
    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="*" element={<div className="flex flex-col items-center justify-center h-[60vh] gap-3"><p className="text-6xl font-bold text-gray-200">404</p><p className="text-gray-500">Page introuvable</p></div>} />
        </Routes>
      </BrowserRouter>
    </AuthProvider>
  );
